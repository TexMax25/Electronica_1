...
public class RegisterScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Registrarse_text = new javax.swing.JLabel();
        Iniciar_sesion_btn = new javax.swing.JLabel();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(nombre_app, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        registro_text.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        registro_text.setForeground(new java.awt.Color(0, 59, 70));
        registro_text.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        registro_text.setText("Registro");
        bg.add(registro_text, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 90, 190, 60));
        ...
        register_btn.setBackground(new java.awt.Color(102, 165, 173));
        register_btn.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        Registrarse_text.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Registrarse_text.setForeground(new java.awt.Color(0, 59, 70));
        Registrarse_text.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Registrarse_text.setText("Registrarse");
        Registrarse_text.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Registrarse_text.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                Registrarse_textMousePressed(evt);
            }
        });
        ...
        register_btnLayout.setHorizontalGroup(
            ...
            .addComponent(Registrarse_text, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
        );
        register_btnLayout.setVerticalGroup(
            register_btnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Registrarse_text, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );

        bg.add(register_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 380, 170, 40));

        Iniciar_sesion_btn.setForeground(new java.awt.Color(153, 153, 153));
        Iniciar_sesion_btn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Iniciar_sesion_btn.setText("Iniciar Sesion");
        Iniciar_sesion_btn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Iniciar_sesion_btn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                Iniciar_sesion_btnMousePressed(evt);
            }
        });
        bg.add(Iniciar_sesion_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 430, 170, -1));
        bg.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 450, 90, 10));
    ...
    private void Registrarse_textMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Registrarse_textMousePressed
        try {
            String user = user_entry.getText();
            String password = String.valueOf(password_entry.getPassword());
            
            
            String query1 = "SELECT * FROM usuario WHERE user='"+user+"'";
            ...
            if (rs.next()){
                ...
                String query = "INSERT INTO usuario VALUES(NULL, '"+user+"', '"+password+"', puntos=-1)";
    ...
    }//GEN-LAST:event_Registrarse_textMousePressed

    private void Iniciar_sesion_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Iniciar_sesion_btnMousePressed
        LoginScreen l = new LoginScreen();
        l.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_Iniciar_sesion_btnMousePressed
    ...
    private javax.swing.JLabel Iniciar_sesion_btn;
    private javax.swing.JLabel Registrarse_text;
