 ...
 * @author santi
 */
public class Kirchoff_Test2 extends javax.swing.JFrame {
    ...
    int points = 0;
    private int puntos;
    public static int puntos_krf;

    
    public Kirchoff_Test2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Kirchoff/Circuito2.png"))); // NOI18N
        bg.add(Imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(134, 36, 540, 240));
        ...
        Pregunta_1.setText("Cuanto es la corriente I2?  (Nodos)");
        ...
        Pregunta_panelLayout.setHorizontalGroup(
            ...
            .addComponent(Pregunta_1, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
        );
        ...
        Pregunta_2.setText("Cuanto es la corriente I3?  (Nodos)");
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true && this.is_correct2 == true){
            this.points += 200;
            Reto_Kirchoff kf = new Reto_Kirchoff();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kirchoff_Test2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kirchoff_Test2().setVisible(true);
            }
        });
    }
