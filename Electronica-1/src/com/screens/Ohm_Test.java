 ...
 * @author santi
 */
public class Ohm_Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Ohm/Circuito1.png"))); // NOI18N
        ...
        Pregunta_1.setText("Cuanto es el valor de la corriente?");
        ...
        Imagen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Ohm/Circuito2.png"))); // NOI18N
        ...
        Pregunta_2.setText("Cuanto es el valor de la corriente?");
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true && this.is_correct2 == true){
            this.points += 200;
            Ohm_Test1 ohm = new Ohm_Test1();
            ohm.getPoints(this.points);
            JOptionPane.showMessageDialog(this, "Ha conseguido: "+this.points+" puntos");
            ohm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ohm_Test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
