 ...
 * @author santi
 */
public class S_P_Test2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Serie_y_Paralelo/Circuito5.png"))); // NOI18N
        ...
        Pregunta_panelLayout.setHorizontalGroup(
            ...
            .addComponent(Pregunta_1, javax.swing.GroupLayout.DEFAULT_SIZE, 788, Short.MAX_VALUE)
        );
        ...
        bg.add(PanelQ_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 800, 520));
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true){
            this.points += 100;
            Reto_SP sp = new Reto_SP();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S_P_Test2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
