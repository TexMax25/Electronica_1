 ...
 * @author santi
 */
public class Reto_Kirchoff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Pregunta_1.setText("<html>Les proponemos el reto de encontrar las correintes que pasan por cada malla y los voltajes que pasan por las resistencias.</html>");
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Retos/Kirchoff.png"))); // NOI18N
        ...
        PanelQ_1Layout.setHorizontalGroup(
            ...
            .addGroup(PanelQ_1Layout.createSequentialGroup()
                .addGap(148, 148, 148)
                .addComponent(Imagen, javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        ...
        String query = "UPDATE usuario SET puntos='"+(this.points + Puntos_sp + Puntos_ohm + Puntos_rl)+"' WHERE user='"+users+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reto_Kirchoff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reto_Kirchoff().setVisible(true);
            }
        });
    }
