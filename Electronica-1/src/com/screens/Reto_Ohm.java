 ...
 * @author santi
 */
public class Reto_Ohm extends javax.swing.JFrame {
    ...
    public Reto_Ohm() {
        ...
        Pregunta_1.setText("<html> Tenemos un circuito simple al cual se le desconoce cuanto es la resistencia con la que cuenta. <p><html>"
                + "<html>Se concocen los valores de la corriente que pasa por el circuito y el voltaje de la fuente,<p><html>"
                + "<html>La corriente que pasa es de: 45.8mA<p><html>"
                + "<html>El voltaje de la fuente es de: 12V<p><html>"
                + "<p>"
                + "<p>"
                + "<html>Te retamos a hallar el valor de la resistencia solo con estos datos<html>");
    }
    ...
    private void initComponents() {
        ...
        Pregunta_panelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Pregunta_panelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        Pregunta_panelLayout.setVerticalGroup(
            ...
            .addGroup(Pregunta_panelLayout.createSequentialGroup()
                .addComponent(Pregunta_1, javax.swing.GroupLayout.PREFERRED_SIZE, 387, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        ...
        String query = "UPDATE usuario SET puntos='"+(this.points + Puntos_sp + Puntos_rl + Puntos_kf)+"' WHERE user='"+users+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reto_Ohm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
