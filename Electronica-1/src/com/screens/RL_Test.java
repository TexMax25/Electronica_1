 ...
 * @author santi
 */
public class RL_Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/RL_RC/Circuitos.png"))); // NOI18N
        bg.add(Imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 36, 430, 240));
        ...
        Pregunta_1.setText("Cuales son los componentes presentes en un circuito RL?");
        ...
        Opcion_A1.setText("Capacitor, Fuente, Bobina");
        ...
        Opcion_B1.setText("Fuente, Resistencia, Capacitor");
        ...
        Opcion_C1.setText("Bobina, Capacitor, Resistencia");
        ...
        Opcion_D1.setText("Bobina, Resistencia, Fuente");
        ...
        PanelQ_1Layout.setHorizontalGroup(
            ...
            .addGroup(PanelQ_1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(PanelQ_1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(OpcionD1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionC1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionB1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionA1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Pregunta_panel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        Pregunta_2.setText("<html>Con qué tipo de ecuaciones se modelan los circuitos de primer orden?</html>");
        ...
        Pregunta_panel1Layout.setHorizontalGroup(
            ...
            .addGroup(Pregunta_panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Pregunta_2, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Opcion_A2.setText("Están modelados con ecuaciones diferenciales de segundo orden.");
        ...
        Opcion_B2.setText("Están modelados con ecuaciones diferenciales.");
        ...
        Opcion_C2.setText("Están modelados con ecuaciones lineales.");
        ...
        Opcion_D2.setText("Están modelados con ecuaciones cuadraticas.");
        ...
        PanelQ_2Layout.setHorizontalGroup(
            ...
            .addGroup(PanelQ_2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(PanelQ_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(OpcionD2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionC2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionB2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(OpcionA2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Pregunta_panel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void Opcion_A1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_A1MousePressed
        ...
        if (Opcion_A1.getLabel() == "Bobina, Resistencia, Fuente"){
            is_correct1 = true;
    ...
    private void Opcion_B1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_B1MousePressed
        ...
        if (Opcion_B1.getLabel() == "Bobina, Resistencia, Fuente"){
            is_correct1 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct1 = false;
    ...
    private void Opcion_C1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_C1MousePressed
        ...
        if (Opcion_C1.getLabel() == "Bobina, Resistencia, Fuente"){
            is_correct1 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct1 = false;
    ...
    private void Opcion_D1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_D1MousePressed
        ...
        if (Opcion_D1.getLabel() == "Bobina, Resistencia, Fuente"){
            is_correct1 = true;
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true && this.is_correct2 == true){
            this.points += 500;
            Reto_RL rl = new Reto_RL();
            rl.getPoints(this.points);
    ...
    private void Opcion_A2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_A2MousePressed
        ...
        if (Opcion_A2.getLabel() == "Están modelados con ecuaciones diferenciales."){
            is_correct2 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct2 = false;
    ...
    private void Opcion_B2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_B2MousePressed
        ...
        if (Opcion_B2.getLabel() == "Están modelados con ecuaciones diferenciales."){
            is_correct2 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct2 = false;
    ...
    private void Opcion_C2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_C2MousePressed
        ...
        if (Opcion_C2.getLabel() == "Están modelados con ecuaciones diferenciales."){
            is_correct2 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct2 = false;
    ...
    private void Opcion_D2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Opcion_D2MousePressed
        ...
        if (Opcion_D2.getLabel() == "Están modelados con ecuaciones diferenciales."){
            is_correct2 = true;
            System.out.println("Es Correcto");
        }else{
            is_correct2 = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RL_Test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
