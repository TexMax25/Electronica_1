 ...
 * @author santi
 */
public class S_P_Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Serie_y_Paralelo/Circuito1.png"))); // NOI18N
        ...
        Opcion_A1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Opcion_A1ActionPerformed(evt);
            }
        });
        ...
        Opcion_B1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Opcion_B1ActionPerformed(evt);
            }
        });
        ...
        Opcion_C1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Opcion_C1ActionPerformed(evt);
            }
        });
        ...
        Opcion_D1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Opcion_D1ActionPerformed(evt);
            }
        });
        ...
        Imagen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Serie_y_Paralelo/Circuito2.png"))); // NOI18N
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true && this.is_correct2 == true){
            this.points += 200;
            S_P_Test1 sp = new S_P_Test1();
            sp.getPoints(this.points);
    ...
    private void Opcion_C1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Opcion_C1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Opcion_C1ActionPerformed

    private void Opcion_B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Opcion_B1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Opcion_B1ActionPerformed

    private void Opcion_A1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Opcion_A1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Opcion_A1ActionPerformed

    private void Opcion_D1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Opcion_D1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Opcion_D1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S_P_Test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
