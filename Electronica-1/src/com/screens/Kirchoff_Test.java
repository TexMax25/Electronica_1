 ...
 * @author santi
 */
public class Kirchoff_Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Kirchoff/Circuito1.png"))); // NOI18N
        ...
        Pregunta_1.setText("Cuanto es la corriente I1?  (Mallas)");
        ...
        Pregunta_2.setText("Cuanto es la corriente I2?  (Mallas)");
    ...
    private void next_btnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_next_btnMousePressed
        if (this.is_correct1 == true && this.is_correct2 == true){
            this.points += 200;
            Kirchoff_Test1 kf = new Kirchoff_Test1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kirchoff_Test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kirchoff_Test().setVisible(true);
            }
        });
    }
